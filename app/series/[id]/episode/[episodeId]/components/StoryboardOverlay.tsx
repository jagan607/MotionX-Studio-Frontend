...
// REMOVE: import { TimelineEditor } from "./TimelineEditor"; 
...
interface StoryboardOverlayProps {
    ...
    shotMgr: any; // Simplified type for brevity
    inpaintData: any;
    setInpaintData: any;
    onSaveInpaint: any;
    onApplyInpaint: any;
...
export const StoryboardOverlay: React.FC<StoryboardOverlayProps> = ({
    ...
    seriesId, episodeId, // <--- Destructure IDs
    ...
    const handleOpenTimeline = () => {
        // Navigate to the new page, passing the current scene ID as a query param
        router.push(`/series/${seriesId}/episode/${episodeId}/timeline?sceneId=${activeSceneId}`);
    };
        ...
        <div style={styles.sbOverlay}>
            ...
            <div style={styles.sbHeader}>
                ...
                <div style={{ marginLeft: 'auto', display: 'flex', gap: '10px' }}>
                    ...
                    {/* --- 3. UPDATED TIMELINE BUTTON --- */}
                    {/* <button
                        onClick={handleOpenTimeline} // Calls router.push
                        style={{
                            padding: '12px 24px',
                    ...
                    {shotMgr.shots.length > 0 && (
                        <button
                            ...
                            style={{
                                ...
                                display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px', letterSpacing: '1px',
                                opacity: ((shotMgr.loadingShots.size > 0 && !shotMgr.isGeneratingAll) || shotMgr.isAutoDirecting || shotMgr.isStopping) ? 0.5 : 1,
                                transition: 'all 0.2s ease', minWidth: '180px', justifyContent: 'center'
                            }}
                        >
            ...
            {showGenerateWarning && (
                <DeleteConfirmModal
                    ...
                    message="Generating all frames will PERMANENTLY DELETE any existing images or videos created for these shots."
                    isDeleting={isWiping}
