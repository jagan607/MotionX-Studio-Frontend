    ...
    return (
        <div
            ...
            className={`
                ...
                ${isBestValue
                    ? 'border-[#D40A12] bg-[#0A0000] hover:bg-[#1A0505]'
                    : 'border-[#222] bg-[#0A0A0A] hover:border-[#444] hover:bg-[#1a1a1a]'
                }
        ...
        >
            ...
            {label && (
                <div className={`
                    ...
                    ${isBestValue ? 'bg-[#D40A12] text-white' : 'bg-[#333] text-[#CCC]'}
                `}>
                    {label}
                </div>
            )}
            ...
            <button
                ...
                className={`
                    ...
                    ${isBestValue
                        ? 'bg-[#D40A12] text-white hover:bg-[#CC0000]'
