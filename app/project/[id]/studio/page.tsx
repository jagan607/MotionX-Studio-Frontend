...
export default function StudioPage() {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-[#050505] text-[#EEE] font-sans overflow-hidden flex flex-col">
            ...
            {/* --- CSS OVERRIDES --- */}
            <style jsx global>{`
                /* 1. Force SceneCards to match the Brutalist Theme */
            ...
            <div className="flex-1 flex overflow-hidden relative z-40">
                ...
                {/* LEFT: REEL SELECTOR (Only relevant for Series/Micro-Dramas, but nice to have for single movies too as "Reel 1") */}
