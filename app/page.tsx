...
export default function LandingPage() {
  ...
  return (
    <main className="bg-[#050505] min-h-screen text-[#EAEAEA] overflow-x-hidden relative">
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <a href="https://discord.gg/hjFJRer8" target="_blank" rel="noopener noreferrer"
              className="text-[11px] font-semibold tracking-[0.15em] uppercase text-neutral-300 hover:text-white transition-colors flex items-center gap-1.5"
            >
            ...
            <Link href="/pricing" className="text-[11px] font-semibold tracking-[0.15em] uppercase text-neutral-300 hover:text-white transition-colors">
              Pricing
            </Link>
            <Link href="/login"
      ...
      {/* ════════════════════════════════════════════════════════════════════ */}
      {/* 8.5. DISCORD COMMUNITY STRIP                                      */}
      {/* ════════════════════════════════════════════════════════════════════ */}
      <section className="py-16 px-6 md:px-10 border-t border-white/[0.04]">
        <div className="max-w-[800px] mx-auto text-center">
          <p className="text-[13px] text-neutral-500 leading-relaxed mb-5">
            Need support, have a feature request, or exploring enterprise deals?{' '}
            <span className="text-neutral-400">Join our community.</span>
          </p>
          <a
            href="https://discord.gg/hjFJRer8"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-[12px] font-semibold tracking-[0.12em] uppercase text-neutral-300 hover:text-white transition-colors"
          >
