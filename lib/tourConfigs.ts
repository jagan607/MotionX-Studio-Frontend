...
export const DASHBOARD_TOUR_STEPS: TourStep[] = [
    {
        ...
        body: "This monitor previews your active project. Click a project in the film strip below to switch, or double-click to open and start directing.",
        placement: "bottom",
    },
    {
        targetId: "tour-project-grid",
        title: "YOUR PROJECTS",
        body: "Your production library. We've added a sample project to get you started — click to preview, double-click to open it in the studio.",
        placement: "top",
    },
    {
        targetId: "tour-hero-actions",
        title: "START DIRECTING",
        body: "Create a new project, jump into the Playground for instant AI generation, or explore community-created films for inspiration.",
        placement: "left",
    },
    {
        targetId: "tour-templates",
        title: "PROJECT TEMPLATES",
        body: "Kickstart your project with a template. Describe your idea or pick a pre-built template — AI will generate your script, cast, locations, and shot breakdowns automatically.",
        placement: "top",
    },
    {
...
export const STORYBOARD_TOOLBAR_TOUR_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        title: "AI DIRECTOR",
        body: "Let AI auto-create a shot list with camera angles, prompts, and casting — based on your scene's mood, cinematography, and character profiles.",
        placement: "bottom",
    },
    {
        targetId: "tour-sb-add-shot",
        title: "ADD SHOTS",
        body: "Manually add blank shots to your sequence. You control the shot count, framing, and can drag to reorder.",
        placement: "bottom",
    },
    {
        targetId: "tour-sb-credits",
        title: "PRODUCTION FUEL",
        body: "Your generation credits. Each AI render, animation, or voiceover costs credits. Top up here when low.",
        placement: "bottom",
        arrowSide: "right",
    },
    {
        ...
        title: "SCENE CONTEXT",
        body: "Edit your scene summary, set mood and cinematography style, review location, time of day, and cast. All of this guides AI shot generation.",
        placement: "bottom",
    },
];
...
export const SHOT_SETTINGS_TOUR_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        title: "AI ENGINE",
        body: "Choose your video engine — Seedance 2.0 for cinematic motion, Wan2.1 for naturalistic movement, Kling for element control, or Luma Uni-1 for experimental renders.",
        placement: "left",
    },
    {
...
export const STUDIO_TOUR_STEPS: TourStep[] = [
    {
        ...
        title: "PRODUCTION FUEL",
        body: "Your credit balance lives here. Every AI generation — scripts, images, video, voiceover — draws from this pool.",
        placement: "bottom",
        arrowSide: "right",
    },
    {
        ...
        body: "Add scenes manually, let AI auto-extend your narrative, edit the script, or manage your asset database — all from this command bar.",
        placement: "bottom",
    },
    {
        targetId: "tour-studio-switcher",
        title: "PROJECT SWITCHER",
        body: "Jump between projects instantly. Your full production library is one click away.",
        placement: "bottom",
        arrowSide: "left",
    },
    {
        ...
        title: "SCENE CARD",
        body: "Each card represents one scene. You can see the synopsis, location, and cast at a glance. Drag to reorder your narrative.",
        placement: "right",
    },
    {
        targetId: "tour-studio-edit-scene",
        title: "DIRECTOR CONSOLE",
        body: "Open the Director Console to rewrite dialogue, reassign cast, change locations — all with AI assistance at your fingertips.",
        placement: "bottom",
    },
    {
        targetId: "tour-studio-open-sb",
        title: "OPEN STORYBOARD",
        body: "This is where the magic happens. Open the storyboard to generate AI frames, animate your shots, and bring your scenes to life.",
        placement: "top",
    },
    {
        targetId: "tour-studio-sidebar",
        title: "REEL SIDEBAR",
        body: "Switch between episodes (reels) here. Each reel holds its own scenes, storyboards, and production timeline.",
        placement: "right",
    },
];
...
export const PREPRODUCTION_TOUR_STEPS: TourStep[] = [
    {
        ...
        body: "Your visual command center. Scenes appear as clapperboards, characters as Polaroid cards, and locations as cinematic frames — all connected by relationship wires.",
        placement: "bottom",
    },
    {
        targetId: "tour-preprod-toolbar",
        title: "ASSET TOOLBAR",
        body: "Add characters, locations, or props to your canvas. Set mood boards and cinematography direction. Each tool creates a new draggable node on your production map.",
        placement: "right",
    },
    {
        targetId: "tour-preprod-assets-btn",
        title: "ASSET MANAGER",
        body: "Open the full asset database. Browse all characters, locations, and products — bulk-generate visuals, configure voice profiles, and fine-tune every detail.",
        placement: "bottom",
        arrowSide: "right",
    },
    {
        ...
        title: "SCRIPT EDITOR",
        body: "Upload or paste your screenplay here. AI will extract scenes, characters, and locations automatically and populate them on the canvas.",
        placement: "bottom",
    },
    {
    ...
    },
    {
        ...
        title: "START DIRECTING",
        body: "Head to Production to open the storyboard — generate AI frames, animate shots, and build your film scene by scene.",
        placement: "bottom",
        arrowSide: "right",
    },
];
...
export const PLAYGROUND_TOUR_STEPS: TourStep[] = [
    {
        ...
        body: "Pick a pre-made prompt + style to get started instantly. Each template is optimized for a specific look — fashion, cinematic, product, and more. Click to apply it to your prompt bar.",
        placement: "left",
    },
    {
        targetId: "tour-pg-assets",
        title: "YOUR ASSETS",
        body: "Upload character references, locations, and products here. Use @tags in your prompt to anchor them — the AI will maintain their appearance across generations.",
        placement: "right",
    },
    {
        targetId: "tour-pg-prompt",
        title: "PROMPT BAR",
        body: "Type what you want to see. Use @ to tag your uploaded characters and locations. Hit the ✨ wand to let AI enhance your prompt, then press Enter to generate.",
        placement: "top",
    },
    {
        targetId: "tour-pg-settings",
        title: "STYLE CONTROLS",
        body: "Fine-tune your generation — choose the AI engine (Gemini / SeedReam / Wan2.1), aspect ratio, shot type, and visual style. These settings apply to every generation.",
        placement: "top",
        arrowSide: "left",
    },
    {
        ...
        body: "Your AI creations appear here in real-time. Click any image to expand, animate it into video, or use it as a reference for your next generation.",
        placement: "bottom",
    },
];
