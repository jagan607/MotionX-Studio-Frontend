...
export const StudioLayout: React.FC<{ children: ReactNode }> = ({ children }) => {
    return (
        ...
        // 2. pt-[70px]: Reduced top padding to pull content up closer to the header.
        // 3. pb-4: Minimal bottom padding to maximize vertical space.
        <main className="h-screen bg-motion-bg bg-studio-gradient text-motion-text font-sans flex justify-center items-start pt-[70px] pb-4 px-4 lg:px-8 overflow-hidden">
