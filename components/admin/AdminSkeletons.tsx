...
// --- CHART SKELETON ---
// Matches: OverviewChart parent → h-[300px] w-full bg-[#161616] border border-[#222] p-4
export function ChartSkeleton() {
    return (
        <div className="h-[300px] w-full bg-[#161616] border border-[#222] p-4 relative">
            {/* Corner markers */}
...
// --- CMS SKELETON ---
// Matches: CMS section → bg-[#161616] border border-[#222] p-6 with 3 input fields + button
export function CmsSkeleton() {
    return (
        <div className="bg-[#161616] border border-[#222] p-6 relative overflow-hidden">
            ...
            <div className="space-y-4">
                ...
                {[1, 2, 3].map((i) => (
                    <div key={i} className="space-y-1">
                        ...
                        <div className="h-11 w-full bg-[#1a1a1a] border border-[#222] animate-pulse" style={{ animationDelay: `${i * 150}ms` }} />
                    </div>
                ))}

                {/* Button placeholder */}
                <div className="flex justify-end pt-2">
                    <div className="h-9 w-40 bg-[#1a1a1a] border border-[#222] animate-pulse" />
                </div>
            </div>
        </div>
    );
...
// Matches: Audit stream → bg-[#161616] border border-[#222] flex flex-col h-full max-h-[600px]
                ...
                {Array.from({ length: 10 }).map((_, i) => (
                    <div key={i} className="p-4 border-b border-[#1A1A1A]">
                        <div className="flex justify-between mb-1">
                            ...
                            <div className="h-3 w-12 bg-[#1a1a1a] animate-pulse rounded-sm" style={{ animationDelay: `${i * 80 + 40}ms` }} />
                        </div>
                        <div className="h-3 w-3/4 bg-[#1a1a1a] mt-2 animate-pulse rounded-sm" style={{ animationDelay: `${i * 80 + 60}ms` }} />
                    </div>
                ))}
            </div>
        </div>
...
// Matches: Users page → border border-[#222] bg-[#161616] max-h-[80vh] with 8-column table
                    ...
                    {Array.from({ length: 8 }).map((_, i) => (
                        <tr key={i}>
                            ...
                            <td className="p-4 border-r border-[#222]">
                                <div className="h-4 w-28 bg-[#1a1a1a] rounded animate-pulse mb-1" style={{ animationDelay: `${i * 100}ms` }} />
                                <div className="h-2.5 w-36 bg-[#0D0D0D] rounded animate-pulse" style={{ animationDelay: `${i * 100 + 50}ms` }} />
                            </td>
                            <td className="p-4 border-r border-[#222]">
                                <div className="h-4 w-16 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 100 + 20}ms` }} />
                            </td>
                            <td className="p-4 border-r border-[#222]">
                                <div className="h-3 w-24 bg-[#1a1a1a] rounded animate-pulse mb-1" style={{ animationDelay: `${i * 100 + 30}ms` }} />
                                <div className="h-3 w-24 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 100 + 60}ms` }} />
                            </td>
                            <td className="p-4 border-r border-[#222]">
                                <div className="h-3 w-20 bg-[#1a1a1a] rounded animate-pulse mb-1" style={{ animationDelay: `${i * 100 + 40}ms` }} />
                                <div className="h-3 w-16 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 100 + 70}ms` }} />
                            </td>
                            <td className="p-4 border-r border-[#222]">
                                <div className="h-6 w-12 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 100 + 50}ms` }} />
                            </td>
                            <td className="p-4 border-r border-[#222]">
                                <div className="h-5 w-14 bg-[#1a1a1a] border border-[#222] rounded animate-pulse" style={{ animationDelay: `${i * 100 + 60}ms` }} />
                            </td>
                            <td className="p-4 text-right">
                                <div className="h-8 w-24 bg-[#1a1a1a] border border-[#222] ml-auto animate-pulse" style={{ animationDelay: `${i * 100 + 70}ms` }} />
                            </td>
                        </tr>
                    ))}
                </tbody>
...
export function FinanceTableSkeleton() {
    return (
        <div className="space-y-8">
            {/* Chart placeholder */}
            <div className="h-[300px] w-full bg-[#161616] border border-[#222] p-4 animate-pulse" />

            {/* Stats row */}
            <div className="grid grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-[#161616] border border-[#222] p-6">
                        <div className="h-2.5 w-24 bg-[#1a1a1a] rounded animate-pulse mb-3" />
                        <div className="h-10 w-28 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 150}ms` }} />
                    </div>
                ))}
            </div>
                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-[#222]">
                        {Array.from({ length: 6 }).map((_, i) => (
                            <tr key={i}>
                                <td className="p-4 border-r border-[#222]"><div className="h-3 w-20 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 80}ms` }} /></td>
                                <td className="p-4 border-r border-[#222]"><div className="h-3 w-32 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 80 + 20}ms` }} /></td>
                                <td className="p-4 border-r border-[#222]"><div className="h-5 w-20 bg-[#1a1a1a] border border-[#222] rounded animate-pulse" style={{ animationDelay: `${i * 80 + 40}ms` }} /></td>
                                <td className="p-4 border-r border-[#222]"><div className="h-3 w-16 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 80 + 60}ms` }} /></td>
                                <td className="p-4"><div className="h-3 w-16 bg-[#1a1a1a] rounded animate-pulse" style={{ animationDelay: `${i * 80 + 80}ms` }} /></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
