    ...
    return (
        <div className="fixed bottom-6 right-6 z-[200] flex flex-col items-end gap-3">
            ...
            {showTranscript && assistantText && (
                <div
                    ...
                    style={{
                        ...
                        boxShadow: "0 8px 32px rgba(0,0,0,0.6), 0 0 0 1px rgba(229,9,20,0.05)",
                    }}
                >
                    <div className="flex items-center gap-2 mb-1.5">
                        <Volume2 size={10} className="text-[#E50914]/60" />
            ...
            {state === "recording" && userText && (
                <div className="max-w-[280px] rounded-xl px-3 py-2 bg-[#E50914]/[0.08] border border-[#E50914]/15">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    style={{
                        background: state === "recording"
                            ...
                            : state === "responding"
                                ? "linear-gradient(135deg, #E50914, #B30710)"
                                : isLocked
                                    ? "linear-gradient(135deg, rgba(40,40,40,0.9), rgba(20,20,20,0.95))"
                                    : state === "connecting" || state === "processing"
                                        ? "linear-gradient(135deg, rgba(229,9,20,0.3), rgba(10,10,10,0.9))"
                                        : isActive
                                            ? "linear-gradient(135deg, rgba(229,9,20,0.6), rgba(139,0,0,0.8))"
                                            : "linear-gradient(135deg, rgba(229,9,20,0.15), rgba(10,10,10,0.95))",
                        boxShadow: state === "recording"
                            ? "0 0 40px rgba(229,9,20,0.5), 0 0 80px rgba(229,9,20,0.2), 0 4px 20px rgba(0,0,0,0.4)"
                            : state === "responding"
                                ? "0 0 30px rgba(229,9,20,0.3), 0 4px 20px rgba(0,0,0,0.4)"
                                : isActive
                                    ? "0 0 20px rgba(229,9,20,0.15), 0 4px 16px rgba(0,0,0,0.3)"
                ...
                >
                    ...
                    {(state === "connecting" || state === "processing") && (
                        <span className="absolute inset-0 rounded-full animate-ping opacity-20 bg-[#E50914]" />
                    )}
