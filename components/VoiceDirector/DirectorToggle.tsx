            ...
            style={{
                background: isRecording
                    ...
                    : isResponding
                        ...
                        : isActive
                            ? "linear-gradient(135deg, rgba(212,10,18,0.2), rgba(10,10,10,0.95))"
                            : "linear-gradient(135deg, rgba(20,20,20,0.95), rgba(10,10,10,0.98))",
                border: isRecording
                    ? "1px solid rgba(212,10,18,0.5)"
                    : "1px solid rgba(255,255,255,0.08)",
                boxShadow: isRecording
                    ? "0 0 30px rgba(212,10,18,0.4), 0 4px 20px rgba(0,0,0,0.4)"
                    : isActive
                        ? "0 0 15px rgba(212,10,18,0.1), 0 4px 16px rgba(0,0,0,0.3)"
        ...
        >
            ...
            {!isActive && !isLocked && (
                <span
                    ...
                    style={{
                        background: "radial-gradient(circle, rgba(212,10,18,0.1), transparent 70%)",
            ...
            {/* Notification dot */}
            {hasUnread && !isOpen && (
                <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-[#D40A12] border-2 border-[#1a1a1a] z-20" />
            )}
